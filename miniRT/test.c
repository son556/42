...
/*   Updated: 2023/04/23 16:54:24 by chanson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../hit.h"

int	where_hit_cylinder(t_discrim disc, t_ray ray, t_cylinder cyl)
{
	double	temp;
	double	t;
	t_vec3	plane;
	...
	else
	{
		...
		temp = len_vec3(sub_vec3(ray_at(ray, t), cyl.c_h));
		if (temp > cyl.radius)
			return (0);
	}
	return (t);
